return {
  {
    ...
    keys = {
      ...
      },
      {
        ...
        desc = "With ARGS; Search for a string in your current working directory and get results live as you type, respects .gitignore",
      },
      {
        "\\\\",
        function()
      ...
      },
      {
        ...
        function()
          ...
          extension.extension.file_browser({
            path = "%:p:h",
